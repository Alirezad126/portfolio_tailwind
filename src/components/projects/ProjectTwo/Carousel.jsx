...

    {
      text: (
        <div className="rounded-3xl p-5 border ">
          <p className="font-extrabold text-3xl text-orange-400 ">How it works? </p>
          <div className="w-full flex gap-5">
            ...
            <div className="text-[#9e9e9e]">
              ...
              <ol>
                <li className="pl-[50px] text-[0.7vw] text-justify ">
            ...
            <div className="w-1/2">
            <div className="order-2 text-[#9e9e9e]">
              <p className="font-light text-xl text-[#ffffff] ">
                <TbPoint className="inline" />
              ...
              <ol>
                ...
                <li className="pl-[50px] text-[0.7vw]">
                  <b>Using History-Aware Retrieval:</b> This system stores the history of the
                  conversation—keeping track of both questions and responses. It
                  then uses this history to reformulate incoming questions,
                  ensuring they can be understood and responded to in isolation.
                  This isolation is crucial for the model to handle each new
                  query as a standalone item, even though it's informed by past
                  interactions. This process allows for precise retrieval and
                  response generation that's deeply integrated with the
